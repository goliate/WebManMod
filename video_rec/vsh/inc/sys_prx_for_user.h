...
extern int sysPrxForUser_04E83D2C(const char *str1, const char *str2, size_t num);  // _sys_strncmp()
#define sys_strncmp sysPrxForUser_04E83D2C

extern char *sysPrxForUser_052D29A6(char *dest, const char *src);  // _sys_strcat()
...
extern int sysPrxForUser_0618936B(char *s, size_t n, const char *fmt, va_list arg);  // _sys_vsnprintf()
#define sys_vsnprintf sysPrxForUser_0618936B

extern int sysPrxForUser_06574237(char *str, size_t size, const char *fmt, ...);  // _sys_snprintf()
...
extern int sysPrxForUser_1573DC3F(sys_lwmutex_t *lwmutex, usecond_t timeout);  // sys_lwmutex_lock()
#define sys_lwmutex_lock sysPrxForUser_1573DC3F

extern char *sysPrxForUser_191F0C4A(const char *s, int c);  // _sys_strrchr()
...
extern int sysPrxForUser_1CA525A2(const char *s1, const char *s2, size_t n);  // _sys_strncasecmp()
#define sys_strncasecmp sysPrxForUser_1CA525A2

// sysPrxForUser_1ED454CE  // sys_spu_elf_get_information

extern int sysPrxForUser_24A1EA07(sys_ppu_thread_t *thread_id, void (*entry)(uint64_t),  // sys_ppu_thread_create()
                                  uint64_t arg, int prio, size_t stacksize,
                                  uint64_t flags, const char *threadname);
...
extern sys_prx_id_t sysPrxForUser_26090058(const char* path, sys_prx_flags_t flags,  // sys_prx_load_module()
                                           sys_prx_load_module_option_t pOpt);
#define sys_prx_load_module sysPrxForUser_26090058

extern void *sysPrxForUser_27427742(void *str1, const void *str2, size_t n);  // _sys_memmove()
#define sys_memmove sysPrxForUser_27427742

extern int sysPrxForUser_2A6D9D51(sys_lwcond_t *lwcond, usecond_t timeout);  // sys_lwcond_wait()
...
extern int sysPrxForUser_2F85C0EF(sys_lwmutex_t *lwmutex, sys_lwmutex_attribute_t *attr);  // sys_lwmutex_create()
#define sys_lwmutex_create sysPrxForUser_2F85C0EF

// sysPrxForUser_3172759D  // sys_game_get_temperature

extern void *sysPrxForUser_318F17E1(size_t alignment, size_t size);  // _sys_memalign()
...
// sysPrxForUser_39E9B068  // ?
// sysPrxForUser_3BD53C7B  // _sys_memchr
...
// sysPrxForUser_459B4393  // _sys_strcmp
// sysPrxForUser_45FE2FCE  // _sys_spu_printf_initialize

extern int sysPrxForUser_4643BA6E(sys_addr_t start_addr, sys_memory_t *mem_id);  // sys_mmapper_unmap_memory()
...
// sysPrxForUser_4B2F301A  // _sys_tolower
// sysPrxForUser_4BBF59D0  // ?
...
extern int sysPrxForUser_52AADADF(sys_lwcond_t *lwcond, sys_ppu_thread_t ppu_thread_id);  // sys_lwcond_signal_to()
#define sys_lwcond_signal_to sysPrxForUser_52AADADF

// sysPrxForUser_5FDFB2FE  // _sys_spu_printf_detach_group

extern int sysPrxForUser_608212FC(sys_mempool_t mempool, void *block);  // sys_mempool_free_block()
...
// sysPrxForUser_68B9B011  // _sys_memset
// sysPrxForUser_6BF66EA7  // _sys_memcpy
// sysPrxForUser_6E05231D  // sys_game_watchdog_stop

extern int sysPrxForUser_70258515(size_t size, sys_memory_container_t container,  // sys_mmapper_allocate_memory_from_container()
                                  uint64_t flags, sys_memory_t *mem_id);
#define sys_mmapper_allocate_memory_from_container sysPrxForUser_70258515

extern int sysPrxForUser_71A8472A(void* addr, uint64_t size);  // sys_get_random_number()
...
// sysPrxForUser_7498887B  // _sys_strchr
// sysPrxForUser_750DD5CD  // ?
// sysPrxForUser_791B9219  // _sys_vsprintf
// sysPrxForUser_7B034C78  // ?
// sysPrxForUser_7DAFF8BB  // ?

extern int sysPrxForUser_80FB0C19(sys_prx_id_t id, size_t args, void *argp,  // sys_prx_stop_module()
                                  int *modres, sys_prx_flags_t flags, sys_prx_stop_module_option_t pOpt);
...
extern int sysPrxForUser_84BB6774(sys_prx_id_t id, sys_prx_flags_t flags,
                                  sys_prx_module_info_t *pInfo);  // sys_prx_get_module_info()
#define sys_prx_get_module_info sysPrxForUser_84BB6774

// sysPrxForUser_87C87495  // ?

extern int sysPrxForUser_893305FA(sys_raw_spu_t id, const char *path, uint32_t *entry);  // sys_raw_spu_load()
...
// sysPrxForUser_996F7CF8  // _sys_strncat
// sysPrxForUser_99C88692  // _sys_strcpy
// sysPrxForUser_9C9605EE  // ?
...
// sysPrxForUser_9F04F7AF  // _sys_printf

extern int sysPrxForUser_9F18429D(sys_prx_id_t id, size_t args, void *argp,  // sys_prx_start_module()
                                  int *modres, sys_prx_flags_t flags, sys_prx_start_module_option_t pOpt);
...
// sysPrxForUser_A1F9EAFE  // _sys_sprintf
...
extern sys_prx_id_t sysPrxForUser_A330AD84(int fd, off64_t offset,  // sys_prx_load_module_on_memcontainer_by_fd()
                                           sys_memory_container_t mem_container, sys_prx_flags_t flags,
                                           sys_prx_load_module_option_t pOpt);
#define sys_prx_load_module_on_memcontainer_by_fd sysPrxForUser_A330AD84

extern void sysPrxForUser_A3E3BE68(int *once_ctrl, void (*init)(void));  // sys_ppu_thread_once()
#define sys_ppu_thread_once sysPrxForUser_A3E3BE68

extern int sysPrxForUser_A5D06BF0(sys_prx_flags_t flags, sys_prx_get_module_list_t *pInfo);  // sys_prx_get_module_list()
#define sys_prx_get_module_list sysPrxForUser_A5D06BF0

// sysPrxForUser_A9879A33  // ?
...
// sysPrxForUser_B1BD7A61  // ?

extern int sysPrxForUser_B257540B(uint64_t size, uint64_t flags, sys_memory_t *mem_id);  // sys_mmapper_allocate_memory()
...
extern int sysPrxForUser_B995662E(sys_raw_spu_t id, sys_spu_image_t *img);  // sys_raw_spu_image_load()
#define sys_raw_spu_image_load sysPrxForUser_B995662E

// sysPrxForUser_B9BF1078  // _sys_heap_alloc_heap_memory
// sysPrxForUser_BAB62B99  // ?
// sysPrxForUser_BDB18F83  // _sys_malloc
// sysPrxForUser_BF8EE5BB  // ?
...
// sysPrxForUser_C4FD6121  // _sys_qsort
// sysPrxForUser_C839BB4C  // ?

extern int sysPrxForUser_CA9A60BF(sys_mempool_t *mempool, void *chunk,  // sys_mempool_create()
                                  const uint64_t chunk_size, const uint64_t block_size,
...
// sysPrxForUser_D3039D4D  // _sys_strncpy
// sysPrxForUser_D66C2D52  // ?
// sysPrxForUser_D8A6F882  // ?

extern int sysPrxForUser_DA0EB71A(sys_lwcond_t *lwcond, sys_lwmutex_t *lwmutex,  // sys_lwcond_create()
...
extern int sysPrxForUser_DC578057(sys_addr_t start_addr, sys_memory_t mem_id,  // sys_mmapper_map_memory()
                                  uint64_t flags);
...
// sysPrxForUser_DE0C682C  // ?
// sysPrxForUser_DE2F9C85  // ?

extern sys_prx_id_t sysPrxForUser_E0998DBF(const char* name, sys_prx_flags_t flags,  // sys_prx_get_module_id_by_name()
...
extern int sysPrxForUser_EBE5F72F(sys_spu_image_t *img, const void *src, uint32_t type);  // sys_spu_image_import()
#define sys_spu_image_import sysPrxForUser_EBE5F72F

// sysPrxForUser_EDEA5F4A  // ?
// sysPrxForUser_EEF75113  // _sys_toupper

extern sys_prx_id_t sysPrxForUser_EF68C17C(int fd, off64_t offset,  // sys_prx_load_module_by_fd()
                                           sys_prx_flags_t flags, sys_prx_load_module_option_t pOpt);
...
extern int sysPrxForUser_F0AECE0D(sys_prx_id_t id, sys_prx_flags_t flags,  // sys_prx_unload_module()
...
// sysPrxForUser_F7F7FB20  // _sys_free
// sysPrxForUser_F82CF400  // ?
// sysPrxForUser_F923DADA  // ?
// sysPrxForUser_FA7F693D  // _sys_vprintf
// sysPrxForUser_FB5DB080  // _sys_memcmp
// sysPrxForUser_FC52A7A9  // sys_game_process_exitspawn
// sysPrxForUser_FECC05B6  // ?
// sysPrxForUser_FF34C76C  // ?
